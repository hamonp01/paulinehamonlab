...
A selection of publications reflecting our research in macrophage biology, cancer immunology, and translational oncology.

<div class="publication-grid">

{% include publication.html lookup="doi:10.1126/science.ady1678" %}

{% include publication.html lookup="doi:10.1038/S41591-025-04177-6" %}

{% include publication.html lookup="doi:10.1101/2025.09.09.675071" %}

{% include publication.html lookup="doi:10.1038/S41551-025-01475-9" %}

{% include publication.html lookup="doi:10.1146/ANNUREV-CANCERBIO-061521-085949" %}
