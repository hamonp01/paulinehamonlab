...
The Hamon lab was established in 2025 to combine fundamental immunology with translational research to better understand the role of macrophages in cancer. Our lab brings together expertise in immunology, spatial biology, single-cell technologies, advanced imaging, and experimental models to study macrophage diversity across solid tumors. By working closely with clinicians and technology platforms, we aim to bridge basic discoveries with clinically relevant applications and contribute to the development of next-generation cancer therapies.
...
Our research combines human studies and experimental approaches to understand how macrophage states are shaped within tumors and how this knowledge can be translated into new therapeutic opportunities. We integrate cutting-edge technologies, including spatial profiling, single-cell approaches, and functional models, to bridge fundamental discoveries and translational applications.
...
{%
  include feature.html
  image="images/Research/Pipetting_1b.JPG"
  link="research"
  title="Our Research"
  flip=true
  style="bare"
